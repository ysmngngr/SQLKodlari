...
--Parent table'dan sildiğimiz için child table'dan silinmiş olur
...
--Yukarda 60'i sınır olarak belirledigimiz icin bunu eklemedi
...
--IN: Birden fazla mantıksal ifade ile tanımlayabilecğimiz durumları tek komutla yazabilme imkanı verir
...
--Ismi t harfi ile biten persomeli listele
select *from personel where isim like '%t';

--Isminin ikinci harfi e olan personeli listele
